...
func getContent(cc echo.Context) error {
	...
	if c.method == echo.POST {
		...
		if request.Header != "" {
			header_arr := strings.Split(request.Header, "&")
			for _, v := range header_arr {
				kv := strings.Split(v, "=")
				if len(kv) > 0 {
					header[string(kv[0])] = string(v[len(kv[0])+1:])
				}
			}
		}
		...
		header_data = c.QueryParam("header")
		if test == "true" {
			header := make(map[string]string)
			cookies := []*http.Cookie{}
			...
			header["User-Agent"] = random_user_agent(is_mobile)
			if header_data != "" {
				header_arr := strings.Split(header_data, "&")
				for _, v := range header_arr {
					kv := strings.Split(v, "=")
					if len(kv) > 0 {
						header[string(kv[0])] = string(v[len(kv[0])+1:])
...
func random_user_agent(is_mobile bool) string {
	browser_strings_mobile := []string{
		...
		"Mozilla/5.0 (Linux; U; Android 2.3.3; en-in; HTC Wildfire S A510e Build/GRI40) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1",
		"Mozilla/5.0 (Linux; U; Android 2.3.3; en-us; Sensation_4G Build/GRI40) AppleWebKit/533.1 (KHTML, like Gecko) Version/5.0 Safari/537.36",
		"Mozilla/5.0 (Linux; U; Android 2.3.3; en-us; Sensation_4G Build/GRI40) AppleWebKit/533.1 (KHTML, like Gecko) Version/5.0 Safari/537.36",
	...
	browser_strings := map[string][]string{
		"Internet Explorer": []string{
			"Mozilla/5.0 (compatible; MSIE 10.6; Windows NT 10.0; Win64; x64; Trident/5.0; InfoPath.2; SLCC1; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729; .NET CLR 2.0.50727) 3gpp-gba UNTRUSTED/1.0",
			"Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 10.0; Win64; x64; WOW64; Trident/6.0)",
			"Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 10.0; Win64; x64; Trident/6.0)",
			"Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 10.0; Win64; x64; Trident/5.0)",
			"Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 10.0; Win64; x64; Trident/4.0; InfoPath.2; SV1; .NET CLR 2.0.50727; WOW64)",
			"Mozilla/4.0 (compatible; MSIE 10.0; Windows NT 10.0; Win64; x64; Trident/5.0)",
			"Mozilla/1.22 (compatible; MSIE 10.0; Windows 3.1)",
			"Mozilla/5.0 (Windows; U; MSIE 9.0; Windows NT 10.0; Win64; x64; en-US))",
			"Mozilla/5.0 (Windows; U; MSIE 9.0; Windows NT 10.0; Win64; x64; en-US)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; WOW64; Trident/5.0; SLCC2; Media Center PC 6.0; InfoPath.3; MS-RTC LM 8; Zune 4.7)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; WOW64; Trident/5.0; SLCC2; Media Center PC 6.0; InfoPath.3; MS-RTC LM 8; Zune 4.7",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; WOW64; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; Zune 4.0; InfoPath.3; MS-RTC LM 8; .NET4.0C; .NET4.0E)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; WOW64; Trident/5.0; chromeframe/12.0.742.112)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; WOW64; Trident/5.0; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET CLR 2.0.50727; Media Center PC 6.0)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Win64; x64; Trident/5.0; .NET CLR 3.5.30729; .NET CLR 3.0.30729; .NET CLR 2.0.50727; Media Center PC 6.0)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Win64; x64; Trident/5.0; .NET CLR 2.0.50727; SLCC2; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; Zune 4.0; Tablet PC 2.0; InfoPath.3; .NET4.0C; .NET4.0E)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Win64; x64; Trident/5.0",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0; yie8)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; InfoPath.2; .NET CLR 1.1.4322; .NET4.0C; Tablet PC 2.0)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0; FunWebProducts)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0; chromeframe/13.0.782.215)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0; chromeframe/11.0.696.57)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0) chromeframe/10.0.648.205",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/4.0; GTB7.4; InfoPath.1; SV1; .NET CLR 2.8.52393; WOW64; en-US)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0; chromeframe/11.0.696.57)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/4.0; GTB7.4; InfoPath.3; SV1; .NET CLR 3.1.76908; WOW64; en-US)",
			"Mozilla/5.0 (Windows; U; MSIE 9.0; Windows NT 10.0; Win64; x64; en-US))",
			"Mozilla/5.0 (Windows; U; MSIE 9.0; Windows NT 10.0; Win64; x64; en-US)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; WOW64; Trident/5.0; SLCC2; Media Center PC 6.0; InfoPath.3; MS-RTC LM 8; Zune 4.7)",
			...
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0; chromeframe/11.0.696.57)",
			"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/4.0; GTB7.4; InfoPath.3; SV1; .NET CLR 3.1.76908; WOW64; en-US)",
			"Mozilla/4.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/4.0; GTB7.4; InfoPath.2; SV1; .NET CLR 4.4.58799; WOW64; en-US)",
			"Mozilla/4.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/4.0; FDM; MSIECrawler; Media Center PC 5.0)",
			"Mozilla/4.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/4.0; GTB7.4; InfoPath.3; SV1; .NET CLR 3.4.53360; WOW64; en-US)",
			"Mozilla/4.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0)",
			"Mozilla/4.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/4.0; .NET CLR 2.0.50727; .NET CLR 1.1.4322; .NET CLR 3.0.04506.648; .NET CLR 3.5.21022; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729; OfficeLiveConnector.1.4; OfficeLivePatch.1.3; .NET4.0C; .NE",
			"Mozilla/4.0 (compatible; MSIE 9.0; Windows 98; .NET CLR 3.0.04506.30)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; Trident/5.0; .NET CLR 2.0.50727; SLCC2; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; InfoPath.3; .NET4.0C)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; WOW64; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; .NET4.0C; .NET4.0E; AskTB5.5)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; WOW64; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; InfoPath.2; .NET4.0C; .NET4.0E)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; Win64; x64; Trident/5.0; .NET4.0C; .NET4.0E; InfoPath.3)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; Win64; x64; Trident/5.0; .NET CLR 2.0.50727; SLCC2; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; InfoPath.3; .NET4.0C)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET4.0C)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; FDM; .NET CLR 1.1.4322; .NET4.0C; .NET4.0E; Tablet PC 2.0)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; .NET4.0C; Tablet PC 2.0; InfoPath.3; .NET4.0E)",
			"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 10.0; Win64; x64; Trident/5.0; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 3.5.30729; .NET CLR 3.0.30729; FDM; .NET4.0C; .NET4.0E; chromeframe/11.0.696.57)",
			"Mozilla/4.0 (compatible; U; MSIE 9.0; Windows NT 10.0; Win64; x64; en-US)",
			"Mozilla/4.0 (compatible; MSIE 9.0; Windows NT 10.0; Win64; x64; Trident/5.0; FunWebProducts)",
		},
		"Firefox": []string{
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; Win64; x64; rv:25.0) Gecko/20100101 Firefox/25.0",
			"Mozilla/5.0 (Macintosh; Intel Mac OS X 10.6; rv:25.0) Gecko/20100101 Firefox/25.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:24.0) Gecko/20100101 Firefox/24.0",
			"Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8; rv:24.0) Gecko/20100101 Firefox/24.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:22.0) Gecko/20130405 Firefox/23.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:23.0) Gecko/20130406 Firefox/23.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; Win64; x64; rv:23.0) Gecko/20131011 Firefox/23.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:22.0) Gecko/20130405 Firefox/22.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; Win64; x64; rv:22.0) Gecko/20130328 Firefox/22.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:22.0) Gecko/20130405 Firefox/22.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; Win64; x64; rv:16.0.1) Gecko/20121011 Firefox/21.0.1",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; Win64; x64; rv:16.0.1) Gecko/20121011 Firefox/21.0.1",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; Win64; x64; rv:21.0.0) Gecko/20121011 Firefox/21.0.0",
			"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:21.0) Gecko/20130331 Firefox/21.0",
			"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:21.0) Gecko/20100101 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:21.0) Gecko/20130326 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:21.0) Gecko/20130401 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:21.0) Gecko/20130331 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:21.0) Gecko/20130330 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:21.0) Gecko/20100101 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:21.0) Gecko/20130401 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:21.0) Gecko/20130328 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:21.0) Gecko/20100101 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:21.0) Gecko/20130401 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:21.0) Gecko/20130331 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:21.0) Gecko/20100101 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:21.0) Gecko/20100101 Firefox/21.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; Win64; x64;) Gecko/20100101 Firefox/20.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:6.0) Gecko/20100101 Firefox/19.0",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:14.0) Gecko/20100101 Firefox/18.0.1",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:18.0) Gecko/20100101 Firefox/18.0",
			"Mozilla/5.0 (X11; Ubuntu; Linux armv7l; rv:17.0) Gecko/20100101 Firefox/17.0",
			"Mozilla/6.0 (Windows NT 10.0; Win64; x64; WOW64; rv:16.0.1) Gecko/20121011 Firefox/16.0.1",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:16.0.1) Gecko/20121011 Firefox/16.0.1",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; Win64; x64; rv:16.0.1) Gecko/20121011 Firefox/16.0.1",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:15.0) Gecko/20120716 Firefox/15.0a2",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US; rv:1.9.1.16) Gecko/20120427 Firefox/15.0a1",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:15.0) Gecko/20120427 Firefox/15.0a1",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64; rv:15.0) Gecko/20120910144328 Firefox/15.0.2",
			"Mozilla/5.0 (X11; Ubuntu; Linux i686; rv:15.0) Gecko/20100101 Firefox/15.0.1",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; rv:15.0) Gecko/20121011 Firefox/15.0.1",
		},
		"Chrome": []string{
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/30.0.1599.17 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.62 Safari/537.36",
			"Mozilla/5.0 (X11; CrOS i686 4319.74.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.57 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/29.0.1547.2 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1468.0 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1467.0 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1464.0 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.93 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.93 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.93 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/27.0.1453.93 Safari/537.36",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.60 Safari/537.17",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.15 (KHTML, like Gecko) Chrome/24.0.1295.0 Safari/537.15",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.14 (KHTML, like Gecko) Chrome/24.0.1292.0 Safari/537.14",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.13 (KHTML, like Gecko) Chrome/24.0.1290.1 Safari/537.13",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.13 (KHTML, like Gecko) Chrome/24.0.1290.1 Safari/537.13",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.13 (KHTML, like Gecko) Chrome/24.0.1284.0 Safari/537.13",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.26 Safari/537.11",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) yi; AppleWebKit/345667.12221 (KHTML, like Gecko) Chrome/23.0.1271.26 Safari/453667.1221",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.17 Safari/537.11",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.4 (KHTML, like Gecko) Chrome/22.0.1229.94 Safari/537.4",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.2 (KHTML, like Gecko) Chrome/22.0.1216.0 Safari/537.2",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/22.0.1207.1 Safari/537.1",
			"Mozilla/5.0 (X11; CrOS i686 2268.111.0) AppleWebKit/536.11 (KHTML, like Gecko) Chrome/20.0.1132.57 Safari/536.11",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/536.6 (KHTML, like Gecko) Chrome/20.0.1092.0 Safari/536.6",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/536.6 (KHTML, like Gecko) Chrome/20.0.1090.0 Safari/536.6",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/19.77.34.5 Safari/537.1",
			"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/536.5 (KHTML, like Gecko) Chrome/19.0.1084.9 Safari/536.5",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/536.5 (KHTML, like Gecko) Chrome/19.0.1084.36 Safari/536.5",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1063.0 Safari/536.3",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1063.0 Safari/536.3",
			"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_0) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1063.0 Safari/536.3",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1062.0 Safari/536.3",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1062.0 Safari/536.3",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1061.1 Safari/536.3",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1061.1 Safari/536.3",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1061.1 Safari/536.3",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1061.0 Safari/536.3",
			"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/535.24 (KHTML, like Gecko) Chrome/19.0.1055.1 Safari/535.24",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/535.24 (KHTML, like Gecko) Chrome/19.0.1055.1 Safari/535.24",
			"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_2) AppleWebKit/535.24 (KHTML, like Gecko) Chrome/19.0.1055.1 Safari/535.24",
			"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_3) AppleWebKit/535.22 (KHTML, like Gecko) Chrome/19.0.1047.0 Safari/535.22",
			"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/535.21 (KHTML, like Gecko) Chrome/19.0.1042.0 Safari/535.21",
			"Mozilla/5.0 (X11; Linux i686) AppleWebKit/535.21 (KHTML, like Gecko) Chrome/19.0.1041.0 Safari/535.21",
			"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_3) AppleWebKit/535.20 (KHTML, like Gecko) Chrome/19.0.1036.7 Safari/535.20",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/535.2 (KHTML, like Gecko) Chrome/18.6.872.0 Safari/535.2 UNTRUSTED/1.0 3gpp-gba UNTRUSTED/1.0",
			"Mozilla/5.0 (Macintosh; AMD Mac OS X 10_8_2) AppleWebKit/535.22 (KHTML, like Gecko) Chrome/18.6.872",
			"Mozilla/5.0 (X11; CrOS i686 1660.57.0) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.46 Safari/535.19",
			"Mozilla/5.0 (Windows NT 10.0; Win64; x64; WOW64) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.45 Safari/535.19",
		...
		"Safari": []string{
			...
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; tr-TR) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; ko-KR) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; fr-FR) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; cs-CZ) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; ja-JP) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; PPC Mac OS X 10_5_8; zh-cn) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; PPC Mac OS X 10_5_8; ja-jp) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_7; ja-jp) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; zh-cn) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; sv-se) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; ko-kr) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; ja-jp) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; it-it) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; fr-fr) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; es-es) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; en-us) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; en-gb) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; de-de) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.4 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; sv-SE) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; ja-JP) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; de-DE) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; hu-HU) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; de-DE) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; ru-RU) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; ja-JP) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; it-IT) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US) AppleWebKit/533.20.25 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_7; en-us) AppleWebKit/534.16+ (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_6; fr-ch) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_5; de-de) AppleWebKit/534.15+ (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_6_5; ar) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; zh-HK) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0.2 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.2 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; tr-TR) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0.2 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; nb-NO) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0.2 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; fr-FR) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0.2 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; zh-TW) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.2 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; ru-RU) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0.2 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US) AppleWebKit/533.17.8 (KHTML, like Gecko) Version/5.0.1 Safari/533.17.8",
			"Mozilla/5.0 (X11; U; Linux x86_64; en-us) AppleWebKit/531.2+ (KHTML, like Gecko) Version/5.0 Safari/531.2+",
			"Mozilla/5.0 (X11; U; Linux x86_64; en-ca) AppleWebKit/531.2+ (KHTML, like Gecko) Version/5.0 Safari/531.2+",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; ja-JP) AppleWebKit/533.16 (KHTML, like Gecko) Version/5.0 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; es-ES) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0 Safari/537.36",
			"Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; ja-JP) AppleWebKit/533.16 (KHTML, like Gecko) Version/5.0 Safari/537.36",
		},
	}
	var (
